...
<html lang="en">
   ...
   <body id="page-top">
      ...
      <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <li class="nav-item">
            <a class="nav-link" href="accounts"> <span>Accounts</span></a>
         </li>
         <!-- Divider -->
         <hr class="sidebar-divider">
         <!-- Nav Item - Tables -->
         <li class="nav-item">
            <a class="nav-link collapsed" href="transactions"> <span>Transactions</span> </a>
         </li>
         <!-- Divider -->
         <hr class="sidebar-divider">
         <!-- Nav Item - Tables -->
         <li class="nav-item">
            <a class="nav-link collapsed" href="users"> <span>Users</span> </a>
         </li>
         <!-- Divider -->
